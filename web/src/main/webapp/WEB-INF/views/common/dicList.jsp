            ...
            <div style="padding:10px 60px 20px 60px">
                <form id="ff" method="post">
                    ...
                    <table cellpadding="5">
                        <tr>
                            <td>节点名:</td>
                            <td><input class="easyui-textbox" type="text" id="dicValue" name="dicValue" style="width:360px;height:36px" data-options="required:true"/></td>
                        </tr>
                        <tr>
                            <td>节点代码:</td>
                            <td><input class="easyui-textbox" type="text" id="dicKey" name="dicKey" style="width:360px;height:36px" data-options="required:true"/></td>
                        </tr>
                        <tr>
                            <td>父节点:</td>
                            <td>
                                <select id="dicPid" name="dicPid" style="width:360px;height:36px" data-options="required:true">
                                </select>
                            </td>
                        </tr>
                    </table>
...
<script type="text/javascript">
    ...
    function setEditForm(node){
        ...
        $("#dicKey").textbox("setValue",node['attributes']['key']);
    ...
    function removeit(){
        ...
        $.ajax({
            type:'get',
            url:'${ctx}/common/dic/del/'+node['id'],
            dataType:'json',
            success:function(data){
                alert(data.msg);
